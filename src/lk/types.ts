...
export interface LegendKeeperClient {
  ...
  updateResource(resourceId: string, patch: UpdateResourcePatch): Promise<Resource>;
  ...
  createDocument(resourceId: string, input: CreateDocumentInput): Promise<LKDocument>;
  updateDocument(
    resourceId: string,
    documentId: string,
